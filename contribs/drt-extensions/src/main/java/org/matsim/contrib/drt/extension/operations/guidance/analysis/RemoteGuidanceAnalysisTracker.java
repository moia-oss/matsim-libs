...
/**
 * Controller-scoped accumulator for the remote-guidance operator-utilisation KPIs (analysis track B1–B5). It subscribes
 ...
 *         incident log (B1), the incident summary (B2), and the operator-busy time series (B3).</li>

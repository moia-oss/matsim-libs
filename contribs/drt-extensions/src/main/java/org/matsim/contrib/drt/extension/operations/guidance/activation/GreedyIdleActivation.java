...
/**
 * Baseline activation trigger reproducing the original greedy behaviour (D4): activate every idle-at-hub vehicle while
 ...
 * set: on its own it drives the active fleet to {@code Σκ} regardless of demand and re-emits every recalled vehicle

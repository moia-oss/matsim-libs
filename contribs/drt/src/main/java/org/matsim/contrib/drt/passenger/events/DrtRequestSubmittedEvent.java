...
public class DrtRequestSubmittedEvent extends PassengerRequestSubmittedEvent {
	...
	public DrtRequestSubmittedEvent(double time, String mode, Id<Request> requestId, List<Id<Person>> personIds,
									...
									double unsharedRideTime, double unsharedRideDistance,
		...
		super(time, mode, requestId, personIds, fromLinkIds, toLinkIds, load, serializedDvrpLoad);
	...
	public static DrtRequestSubmittedEvent convert(GenericEvent event) {
		...
		String[] personIdsAttribute = attributes.get(ATTRIBUTE_PERSON).split(PassengerRequestSubmittedEvent.DELIMITER);
		...
		LinkIds linkIds = PassengerRequestSubmittedEvent.parseLinkIds(attributes);

		return new DrtRequestSubmittedEvent(time, mode, requestId, personIds, linkIds.fromLinkIds(), linkIds.toLinkIds(), unsharedRideTime,

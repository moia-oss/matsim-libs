...
public class SharingFactorTest {
	...
	public void testDrtSharingFactorHandler() {
...

		{
			...
			events.processEvent(new DrtRequestSubmittedEvent(0.0, mode, requestId, List.of(personId1), List.of(), List.of(), 0, 0, 0, 0, 0, 0, null, null));
...

		{
			...
			events.processEvent(new DrtRequestSubmittedEvent(0.0, mode, requestId1, List.of(personId1), List.of(), List.of(), 0, 0, 0, 0, 0, 0, null, null));
			events.processEvent(new DrtRequestSubmittedEvent(0.0, mode, requestId2, List.of(personId2), List.of(), List.of(), 0, 0, 0, 0, 0, 0, null, null));
...

		{
			...
			events.processEvent(new DrtRequestSubmittedEvent(0.0, mode, requestId1, List.of(personId1, personId2), List.of(), List.of(), 0, 0, 0, 0, 0, 0, null, null));
